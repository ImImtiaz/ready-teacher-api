...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 27, 2019 at 10:24 AM
...
--
-- Table structure for table `tranning_package`
--

DROP TABLE IF EXISTS `tranning_package`;
CREATE TABLE IF NOT EXISTS `tranning_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tranning_package`
--

INSERT INTO `tranning_package` (`id`, `code`, `name`) VALUES
(1, '', 'Structure of Language'),
(2, '', 'Concepts in Applied Linguistics');
